...
//           const data = await response.json();
//           setFavoriteStatus(data.some(item => item.content_id === parseInt(contentId)));
//         }
//       } catch (error) {
...
//       } else {
//         console.error(`Failed to ${favoriteStatus ? "delete from" : "add to"} favorites`, response.status);
//       }
//     } catch (error) {
//       console.error(`Error ${favoriteStatus ? "deleting from" : "adding to"} favorites:`, error);
//     }
//   };
...
//             </div>
//             <button
//               className={favoriteStatus ? "added-to-favorites2" : "add-to-favorites2"}
//               onClick={(e) => {
//                 e.preventDefault();
//                 e.stopPropagation();
...
//               }}
//             >
//               {favoriteStatus ? <IoCheckmarkSharp /> : "+"}
//             </button>
//           </div>
//         </div>
...
//             <button
//               className={favoriteStatus ? "added-to-favorites2-desktop" : "add-to-favorites2-desktop"}
//               onClick={(e) => {
//                 e.preventDefault();
//                 e.stopPropagation();
//                 handleAddToFavorites(content.content_id);
...
//       <div className="block-similar-genre">
//         <ReviewSection contentId={id} />
//         <div className="similar-genre">
...
const ContentDetail = ({ contentId }) => {
  ...
  return (
    <div className="details-block">
      ...
      <div className="reviews-and-similar">
